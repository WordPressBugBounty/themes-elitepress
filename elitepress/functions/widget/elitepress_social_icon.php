...
// Creating the widget
	...
	echo $args['before_widget']; ?>
					...
					<ul class="head-contact-social">
						...
						<li class="facebook"><a href="<?php echo esc_url($instance['facebook_link']); ?>" <?php if(!empty($instance['facebook_target'])){ echo "target='_blank'"; } ?> ><i class="fa-brands fa-facebook-f"></i></a></li>
						<?php }

						//Twitter Link
						if(!empty($instance['twitter_link'])) { ?>
						<li class="twitter"><a href="<?php echo esc_url($instance['twitter_link']); ?>" <?php if(!empty($instance['twitter_target'])){ echo "target='_blank'"; } ?> ><i class="fa-brands fa-x-twitter"></i></a></li>
						<?php }

						//Linkedin Link
						if(!empty($instance['linkedin_link'])) { ?>
						<li class="linkedin"><a href="<?php echo esc_url($instance['linkedin_link']); ?>" <?php if(!empty($instance['linkedin_target'])){ echo "target='_blank'"; } ?> ><i class="fa-brands fa-linkedin-in"></i></a></li>
						<?php }

						//Instagram Link
						if(!empty($instance['instagram_link'])) { ?>
						<li class="instagram"><a href="<?php echo esc_url($instance['instagram_link']); ?>" <?php if(!empty($instance['instagram_target'])){ echo "target='_blank'"; } ?> ><i class="fa-brands fa-instagram"></i></a></li>
						<?php }

						//Youtube Link
						if(!empty($instance['youtube_link'])) { ?>
						<li class="youtube"><a href="<?php echo esc_url($instance['youtube_link']); ?>" <?php if(!empty($instance['youtube_target'])){ echo "target='_blank'"; } ?> ><i class="fa-brands fa-youtube"></i></a></li>
						<?php }

						//Skype Link
						if(!empty($instance['skype_link'])) { ?>
						<li class="skype"><a href="<?php echo esc_url($instance['skype_link']); ?>" <?php if(!empty($instance['skype_target'])){ echo "target='_blank'"; } ?> ><i class="fa-brands fa-skype"></i></a></li>
						<?php }

						//Vimeo Link
						if(!empty($instance['vimeo_link'])) { ?>
						<li class="vimeo"><a href="<?php echo esc_url($instance['vimeo_link']); ?>" <?php if(!empty($instance['vimeo_target'])){ echo "target='_blank'"; } ?> ><i class="fa-brands fa-vimeo-square"></i></a></li>
						<?php }

						//Dribble Link
						if(!empty($instance['dribble_link'])) { ?>
						<li class="dribbble"><a href="<?php echo esc_url($instance['dribble_link']); ?>" <?php if(!empty($instance['dribble_target'])){ echo "target='_blank'"; } ?> ><i class="fa-brands fa-dribbble"></i></a></li>
						<?php }?>
